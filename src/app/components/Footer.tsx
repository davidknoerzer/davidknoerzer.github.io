    ...
    return (
        <footer className="footer p-10 bg-neutral text-neutral-content">
            ...
            <nav>
                ...
                <div className="badge badge-outline" key="">React</div>
                <div className="badge badge-outline" key="">TailwindCSS</div>
                <div className="badge badge-outline" key="">DaisyUI</div>
                <div className="badge badge-outline" key="">Next.js</div>
            </nav>
            <nav>
