...
export default function CVSection() {
  const cvChapters: CVChapter[] = [
    {
      title: "IT Consultant",
      organization: "Innovation Process Technology AG",
      description: [
        "Full-Stack Software Engineer mit Angular, Quarkus, Material UI, Tailwind CSS",
      ],
  ...
  return (
    <div className="space-y-4">
      <h2 className="text-6xl p-4 font-bold bg-base-300 shadow-2xl rounded-2xl">
        CV
      </h2>
